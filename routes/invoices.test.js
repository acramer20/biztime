...
describe("GET /", function () {
    test("It should return with an array of invoices", async function () {
...
// QUESTION - line 41 thru 44 zachem eto zdes?

describe("GET /1", function () {
    test("It should return the invoice info", async function () {
...
describe("POST /", function () {
    test("It should add another invoice", async function () {
        const response = await request(app).post("/invoices").send({amt: 10, comp_code: "ibm"});
        expect(response.body).toEqual({
            "invoice": {
                id: 4,
                comp_code: 'ibm',
...
describe("DELETE /", function () {
    test("deletes the invoice", async function () {
        const response = await request(app).delete("/invoices/1");
        expect(response.body).toEqual({"status": "deleted"});

    })
    test("Returns 404 when invoice does not exist", async function () {
